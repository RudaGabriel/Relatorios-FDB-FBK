...
return path.join(up,"Desktop",`(FDB-DIA)_relatorio_${dd}-${mm}-${yy}_gerencial_por_vendedor.html`);
};
...
const histFile=path.join(hist,`(FDB-DIA)_relatorio_${dd}-${mm}-${yy}_${hh}-${mi}_gerencial_por_vendedor.html`);
