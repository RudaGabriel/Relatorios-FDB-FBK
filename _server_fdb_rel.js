...
const dtInicio = info.inicio || isoDate(d);
const dtFim = info.fim || isoDate(d);
const dataISO = dtInicio === dtFim ? dtInicio : `${dtInicio}_ate_${dtFim}`;
