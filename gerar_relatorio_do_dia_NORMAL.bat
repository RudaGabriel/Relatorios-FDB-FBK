...
set "OUT=C:\Users\SERVIDOR\Desktop\relatorio_%DATA_ARQ%_gerencial_por_vendedor.html"
cd /d "%~dp0"
node "C:\Users\SERVIDOR\Desktop\REL\gerencial_por_vendedor_html_fix_width.js" --fdb "%FDB%" --data "%DATA%" --saida "%OUT%" --user SYSDBA --pass masterkey
start "" "%OUT%"
exit /b 0